namespace EtAlii.Generators.MicroMachine.Tests
{
    ...
    public class ParameterStateMachine : ParameterStateMachineBase
    {
        ...
        protected override void OnNextState1Entered(Trigger trigger, NextState1Choices choices) => LogTransition(typeof(Trigger));
        protected override void OnNextState1Entered(Activate1Trigger trigger, NextState1Choices choices) => LogTransition($"{trigger.Title}, {trigger.Count}", typeof(Activate1Trigger));
        ...
        protected override void OnNextState2Entered(Trigger trigger, NextState2Choices choices) => LogTransition(typeof(Trigger));
        protected override void OnNextState2Entered(Activate2Trigger trigger, NextState2Choices choices) => LogTransition($"{trigger.String0}, {trigger.Int1}, {trigger.Float2.ToString(CultureInfo.InvariantCulture)}", typeof(Activate2Trigger));
        ...
        protected override void OnNextState3Entered(Trigger trigger, NextState3Choices choices) => LogTransition(typeof(Trigger));
        protected override void OnNextState3Entered(Activate3Trigger trigger, NextState3Choices choices) => LogTransition($"{trigger.Customer.Id}, {trigger.Project.Id}", typeof(Activate3Trigger));
