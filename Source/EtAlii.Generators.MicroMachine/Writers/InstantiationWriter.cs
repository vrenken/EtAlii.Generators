namespace EtAlii.Generators.MicroMachine
{
    ...
    public class InstantiationWriter
    {
        ...
        public void WriteStateMachineInstantiation(WriteContext<StateMachine> context)
        {
            ...
            context.Writer.WriteLine($"_stateMachine = new {MicroMachineWriter.StateMachineType}(State.{PlantUmlConstant.BeginStateName});");
            ...
            var lines = StateFragment
                ...
                .Select(transition =>
                {
                    ...
                    var methodCast = transition.IsAsync
                        ? $"(Func<{triggerParameterTypes}{MicroMachineWriter.StateMachineType}.Transition, Task>)"
                        : $"(Action<{triggerParameterTypes}{MicroMachineWriter.StateMachineType}.Transition>)";
