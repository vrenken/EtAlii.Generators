namespace EtAlii.Generators.MicroMachine
{
    ...
    {
        private readonly IStateMachineLifetime _lifetime = new MicroStateMachineLifetime();
        ...
        private void Analyze(SymbolAnalysisContext context)
        {
            ...
            {
                // Find the MicroMachine state machine type.
                var stateMachineSymbol = GetStateMachineSymbol(context.Compilation);
                ...
                if (baseType != null)
                {
                    var hasStateMachineMember = baseType
                        ...
                        .Any(m => SymbolEqualityComparer.Default.Equals(m.Type.OriginalDefinition, stateMachineSymbol));
        ...
        private INamedTypeSymbol GetStateMachineSymbol(Compilation compilation)
        {
            return compilation.GetTypeByMetadataName("MicroMachine.StateMachine`2");
        }
    }
}
