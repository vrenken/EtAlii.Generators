...
namespace EtAlii.Generators.ML.Tests
{
    ...
    public class SentimentProgram
    {
        ...
        private const string _modelPath = @"Generated code\SentimentModel";
        ...
        public void Main(string[] args)
        {
            ...
            IEstimator<ITransformer> pipeline =
                ...
                mlContext.Transforms.Text.TokenizeIntoWords("TokenizedWords", "ReviewText")
                    ...
                    .Append(mlContext.Transforms.CustomMapping((Action<VariableLength, FixedLength>) ResizeFeaturesAction, "Resize"))
                    // </SnippetCustomMapping>
        ...
        /// </summary>
        private class MovieReviewSentimentPrediction
        {
            [VectorType(2)]
