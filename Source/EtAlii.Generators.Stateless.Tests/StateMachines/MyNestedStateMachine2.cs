namespace EtAlii.Generators.Stateless.Tests
{
    ...
    public class MyNestedStateMachine2 : MyNestedStateMachine2Base
    {
        ...
        protected override void OnState2EnteredFromContinueTrigger(State2EventArgs e)
        {
        ...
        protected override void OnSubState1EnteredFromStartState2Trigger(SubState1EventArgs e) => Console.WriteLine("SubState 1 entered from StartState 2 trigger");
