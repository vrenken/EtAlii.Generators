namespace EtAlii.Generators.Stateless.Tests
{
    ...
    public class MyNestedStateMachine4 : MyNestedStateMachine4Base
    {
        ...
        protected override Task OnState4Entered(State4EventArgs e) => Task.Run(() => Console.WriteLine("State 4 entered"));
        ...
        protected override void OnState3EnteredFromContinueTrigger(State3EventArgs e) => Console.WriteLine($"State 2 entered from continue trigger");
        ...
        protected override void OnSubState1EnteredFromContinueTrigger(SubState1EventArgs e) => Console.WriteLine("SubState 1 entered from continue trigger");
        ...
        protected override void OnSubState2EnteredFromContinueTrigger(SubState2EventArgs e) => Console.WriteLine("SubState 2 entered from continue trigger");
    }
}
